...
FONTS = {
    "cfont": ImageFont.truetype("Joe_Musicbot/modules/utils/cfont.ttf", 15),
    "dfont": ImageFont.truetype("Joe_Musicbot/modules/utils/font2.otf", 12),
    "nfont": ImageFont.truetype("Joe_Musicbot/modules/utils/font.ttf", 10),
    "tfont": ImageFont.truetype("Joe_Musicbot/modules/utils/font.ttf", 20),
}
...
def add_controls(img: Image.Image) -> Image.Image:
    ...
    region = img.crop(box)
    controls = Image.open("Joe_Musicbot/modules/utils/controls.png").convert("RGBA")
